...
namespace gui
{
	...
	void ImguiEditor::OnEvent(min::Event& e)
	{
		// Block event when ImGui is capturing mouse or keyboard
		if (mBlockEvent)
		{
			ImGuiIO& io = ImGui::GetIO();
			e.Handled |= e.IsInCategory(min::eEventCategory::EventCategoryMouse) & io.WantCaptureMouse;
			e.Handled |= e.IsInCategory(min::eEventCategory::EventCategoryKeyboard) & io.WantCaptureKeyboard;
		}
	}
